...
<head>
  ...
  <!-- bootstrap theme -->
  <link href="{{ url('login/css/bootstrap-theme.css') }}" rel="stylesheet">
  <!--external css-->
  <!-- font icon -->
  <link href="{{ url('login/css/elegant-icons-style.css') }}" rel="stylesheet" />
    ...
    <form class="login-form" action="/postlogin" method="POST">
      ...
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input name="username" id="inputEmailAddress" type="text" class="form-control" placeholder="Username" autofocus>
        </div>
        <div class="input-group">
